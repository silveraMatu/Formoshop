    ...
    <div className="fixed bottom-6 right-6 z-50">
      {isOpen && (
        <div className="w-80 h-[420px] rounded-3xl flex flex-col overflow-hidden mb-4 bg-white/75 dark:bg-neutral-950/70 backdrop-blur-2xl backdrop-saturate-150 border border-white/60 dark:border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.08)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.4)] shadow-[inset_0_1px_1px_rgba(255,255,255,0.6)]">
          ...
          <div className="p-3 border-t border-black/5 dark:border-white/10 flex gap-2">
            ...
            />
            <button onClick={handleSend} disabled={isLoading} className="bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 px-3 py-2 rounded-xl hover:bg-neutral-800 dark:hover:bg-neutral-200 disabled:opacity-50 font-medium transition-all duration-150 active:scale-[0.97]">
              Enviar
            </button>
          </div>
        </div>
      ...
      {!isOpen && (
        <button
          ...
          className="w-14 h-14 rounded-full flex items-center justify-center text-2xl transition-transform hover:scale-105 active:scale-95 bg-white/80 dark:bg-neutral-900/80 backdrop-blur-xl border border-white/60 dark:border-white/15 shadow-[0_20px_50px_rgba(0,0,0,0.08)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.4)] shadow-[inset_0_1px_1px_rgba(255,255,255,0.6)]"
        >
          💬
        </button>
      )}
